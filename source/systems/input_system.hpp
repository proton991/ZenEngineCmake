#ifndef ZENENGINE_INPUT_SYSTEM_HPP
#define ZENENGINE_INPUT_SYSTEM_HPP
#include <array>
...
private:
  ...
  std::array<std::int64_t, 2> m_current_cursor_pos{0, 0};   // [x, y]
  std::array<bool, GLFW_KEY_LAST> m_key_pressed{false};
